      ...
      <body className="font-body antialiased min-h-screen bg-background flex flex-col relative">
        <AuthProvider>
            <div 
              ...
              style={{
                background: 'radial-gradient(ellipse 80% 80% at 50% -20%,rgba(120,119,198,0.3), transparent 50%), radial-gradient(ellipse 80% 80% at 80% -15%,rgba(72,132,196,0.2), transparent 50%), #0D0D1A',
              }}
            />
            <Header />
